...
<main>
    <form:form class="eighty-width my-centered" modelAttribute="characterRequest" action="postModifyCharacterData.html">
        <div class="row my-centered my-button-row">
            <div class="form-inline col-sm-2">
                <button type="submit" class="btn btn-dark my-centered">Modify character</button>
            </div>
            <div class="form-inline col-sm-2">
        ...
        <div class="input-group mb-2">
            ...
            <form:input path="name" type="text" name="name" class="form-control" disabled="true"/>
        </div>
