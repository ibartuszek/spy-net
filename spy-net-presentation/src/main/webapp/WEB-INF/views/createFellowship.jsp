...
<head>
    ...
    <title>Create new Fellowship</title>
</head>
...
<main>
    ...
    <form:form class="eighty-width my-centered" modelAttribute="fellowshipRequest" action="postCreateFellowshipData.html">
        <div class="row my-centered my-button-row">
            <div class="form-inline col-sm-2">
                <button type="submit" class="btn btn-dark my-centered">Add new fellowship</button>
            </div>
            <div class="form-inline col-sm-2">
        ...
        <div class="input-group mb-2">
            ...
            <form:select path="house1" items="${houseNameList}" type="text"
                         name="house1" class="form-control"/>
        </div>
        <form:errors path="house1" element="div" cssClass="alert" class="my-alert"/>
        <div class="input-group mb-2">
            <span class="input-group-addon input-group-text">House's name</span>
            <form:select path="house2" items="${houseNameList}" type="text"
                         name="house2" class="form-control"/>
        </div>
        <form:errors path="house2" element="div" cssClass="alert" class="my-alert"/>
        <div class="input-group mb-2">
            <span class="input-group-addon input-group-text">Fellowship's begin</span>
            <form:input path="begin" type="text" name="name" class="form-control"/>
        </div>
        <form:errors path="begin" element="div" cssClass="alert" class="my-alert"/>
        <div class="input-group mb-2">
